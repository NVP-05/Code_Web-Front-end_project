let productList = [
  {
    id: 1,
    image: ["./src/assets/9781838955823.jpg"],
    name: "Wood Life",
    category: 1,
    author: "Mark Wood",
  ...
  {
    id: 2,
    image: ["./src/assets/9781421520544.jpg"],
  ...
  {
    id: 3,
    image: ["./src/assets/9789389432640.jpg"],
  ...
  {
    id: 4,
    image: ["./src/assets/9781786330895.jpg"],
    name: "Ikigai",
    category: 1,
  ...
  {
    id: 5,
    image: ["./src/assets/9781098136659.jpg"],
...
let categoryList = [
  {
    ...
    image: "./src/assets/sqgouvq4.png",
  },
  {
    id: 2,
    name: "New Arrivals",
    description: "For new exploser and new knowledge",
    image: "./src/assets/new_arrival.jpg",
  },
  {
    id: 3,
    name: "Novels",
    description: "Join in many wonderful imaginary worlds and stories",
    image: "./src/assets/20230919_2XwWzgtu.png",
  },
];

localStorage.setItem("produstList", JSON.stringify(productList));
...
let bookList = JSON.parse(localStorage.getItem("produstList"));
